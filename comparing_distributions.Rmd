...
qq <- gg_qq_empirical((tcf_18ss)$TCF_mRNA_levels, as.numeric((imputed_18ss)$TCF), "TCF", "brown1")
qq + theme_bw(base_family = "Trebuchet MS", base_size = 20) + coord_equal()



quantile(imputed_18ss$Tbxta, quantile_val )
quantile(tbxta_18ss$tbxta, quantile_val )

```

```{r}
ggplot( data = imputed_18ss, aes(x = Tbxta )) + 
